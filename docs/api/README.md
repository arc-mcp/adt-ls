...
- [AdtLsDriver](classes/AdtLsDriver.md)

## Interfaces

- [ObjectRef](interfaces/ObjectRef.md)
- [ActivateResult](interfaces/ActivateResult.md)
- [TransportDiffPage](interfaces/TransportDiffPage.md)
...
- [FederatedResult](interfaces/FederatedResult.md)
- [McpTool](interfaces/McpTool.md)
- [StartMcpServerResult](interfaces/StartMcpServerResult.md)
- [ConnectionOptions](interfaces/ConnectionOptions.md)
- [CreateAdtLsOptions](interfaces/CreateAdtLsOptions.md)
- [AdtLsCapabilities](interfaces/AdtLsCapabilities.md)
- [HealthInfo](interfaces/HealthInfo.md)
- [AdtLsClient](interfaces/AdtLsClient.md)
- [DiscoverOptions](interfaces/DiscoverOptions.md)
- [AdtLsInitializeResult](interfaces/AdtLsInitializeResult.md)
- [LspRequester](interfaces/LspRequester.md)
...
- [REQUIRED\_SAPSE\_ADT\_VSCODE\_VERSION](variables/REQUIRED_SAPSE_ADT_VSCODE_VERSION.md)
- [MINIMUM\_ADT\_LS\_VERSION](variables/MINIMUM_ADT_LS_VERSION.md)
- [VERIFIED\_ADT\_LS\_VERSION](variables/VERIFIED_ADT_LS_VERSION.md)
...
- [clientCert](functions/clientCert.md)
- [interactive](functions/interactive.md)
- [custom](functions/custom.md)
- [parseFederated](functions/parseFederated.md)
- [startMcpServer](functions/startMcpServer.md)
- [startMcpServerWithFallback](functions/startMcpServerWithFallback.md)
- [stopMcpServer](functions/stopMcpServer.md)
- [setMcpDestination](functions/setMcpDestination.md)
- [createAdtLs](functions/createAdtLs.md)
- [platformSubPath](functions/platformSubPath.md)
- [defaultExtensionDirs](functions/defaultExtensionDirs.md)
- [resolveAdtLsPath](functions/resolveAdtLsPath.md)
- [composeSpawnArgs](functions/composeSpawnArgs.md)
- [stderrLogger](functions/stderrLogger.md)
- [setLogger](functions/setLogger.md)
- [parseAdtLsVersion](functions/parseAdtLsVersion.md)
- [isSupportedAdtLsVersion](functions/isSupportedAdtLsVersion.md)
- [assertSupportedAdtLsVersion](functions/assertSupportedAdtLsVersion.md)
